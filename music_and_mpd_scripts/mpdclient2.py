...
list_delim = ["artist", "album", "title", "track", "name", "genre", "date", "composer", "performer", "comment"]
...
commands = {
    ...
    ("find",   4): ('%s "%s" "%s" "%s" "%s"', MANY, '', plitem_delim),
    ...
    # <metadata arg1>
    ("list", 1): ('%s "%s"', MANY, '', list_delim),

    # <metadata arg1> <metadata arg2> <search term>
    ("list", 3): ('%s "%s" "%s" "%s"', MANY, '', list_delim),
}
